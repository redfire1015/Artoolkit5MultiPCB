...
void populateMatrix() {
	...
	//Prepare variables for matrix solve
...
void runSimulation(double timeStep)
{
	...
	ML_INT itr = gmres(&LHS, B, transientNextSolution, LHS.nr, 1e-11); // Solve transient resposne for xn + 1
	...
	std::cout << "************** V1 Interactive **************" << std::endl;
	std::cout << transientNextSolution[31] << std::endl;
